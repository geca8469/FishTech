...
- Working MVP including:
  ...
  - Interactive map with location and information feature
...
- Interactive map feature to link to fish database for more information
- Improvements to "Explore fish" page
...
- Linking the Interactive map to the Explore Fish page
- Improve user features such as favoriting or saving fish and habitats
